...
.progress-buffer-bar {
  ...
  [dir=rtl] .progress, [dir=rtl] .progress-buffer-bar {
...
.indeterminate-bar-primary {
  ...
  [dir=rtl] .indeterminate-bar-primary {
    left: 0;
    right: -145.16661%; }
...
.indeterminate-bar-secondary {
  ...
  [dir=rtl] .indeterminate-bar-secondary {
    left: 0;
    right: -54.88889%; }
...
:host(.progress-bar-reversed) .progress-buffer-bar {
  transform-origin: right top; }
  :host([dir=rtl].progress-bar-reversed) .progress, :host([dir=rtl].progress-bar-reversed) .progress-buffer-bar {
    transform-origin: left top; }
